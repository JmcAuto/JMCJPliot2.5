...
// logic for reverse driving mode
  ...
  void GetPassedDistanceByEsp(SimpleMPCDebug *debug, const canbus::Chassis *chassis);
  ...
  void GetPathRemain(SimpleMPCDebug *debug);
  ...
  double Wheel2SteerToSteerAngle(const double wheel_angle);
