...
DECLARE_string(planning_mode_config_file);
...
DECLARE_bool(enable_square_circle);
...
DECLARE_double(safedistance_normal);
DECLARE_double(safedistance_parking);

DECLARE_bool(enable_parking_valid);

DECLARE_bool(enable_csv_debug);

DECLARE_double(vertical_type_change_end_node_distance);
