...
using jmc_auto::common::VehicleModel;
...
//NEW ADD
  auto position_matched_point = prev_trajectory->TrajectoryPointAt(
      static_cast<uint32_t>(position_matched_index));
  double forward_rel_time = position_matched_point.relative_time() + 0.05;
...
//  if(vehicle_state.linear_velocity() <= 0.01){  
//      matched_index = time_matched_index;
//  }
