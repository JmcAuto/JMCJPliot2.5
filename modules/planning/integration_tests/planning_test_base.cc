...
void PlanningTestBase::SetUpTestCase() {
  ...
  FLAGS_planning_config_file =
      "/jmc_auto/modules/planning/conf/planning_config.pb.txt";
  FLAGS_traffic_rule_config_filename =
      "/jmc_auto/modules/planning/conf/traffic_rule_config.pb.txt";
  FLAGS_smoother_config_filename =
      "/jmc_auto/modules/planning/conf/qp_spline_smoother_config.pb.txt";
  FLAGS_map_dir = "/jmc_auto/modules/planning/testdata";
...
bool PlanningTestBase::FeedTestData() {
  ...
  if (!jmc_auto::cyber::common::GetProtoFromFile(
