...
using jmc_auto::common::SpeedPoint;
using jmc_auto::common::Status;
using jmc_auto::common::util::PointFactory;
...
GriddedPathTimeGraph::GriddedPathTimeGraph(
    ...
    const common::TrajectoryPoint& init_point, bool reacheddestination)
    : st_graph_data_(st_graph_data),
      ...
      dp_st_cost_(dp_config, st_graph_data_.total_time_by_conf(),
                 ...
                 reached_destination_(reacheddestination) {
...
Status GriddedPathTimeGraph::InitCostTable() {
  ...
  dimension_t_ = static_cast<uint32_t>(std::ceil(
                     total_length_t_ / static_cast<double>(unit_t_))) +
                 1;
  ADEBUG << "total_length_t: " << total_length_t_ << "dimension_t_:" << dimension_t_;
  ...
  ADEBUG << "dimension_s_:" << dimension_s_;
