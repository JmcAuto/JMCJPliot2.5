...
using jmc_auto::hdmap::JunctionInfo;
...
//NEW ADD
//    for (size_t i = 0; i < candidate_path_boundaries[1].boundary().size(); ++i) {
//      double s = static_cast<double>(i) * candidate_path_boundaries.delta_s() +
//                 candidate_path_boundaries.start_s();
//      double kappa = reference_line.GetNearestReferencePoint(s).kappa();
//      ddl_bounds.emplace_back(-lat_acc_bound - kappa, lat_acc_bound - kappa);
//      candidate_path_boundaries[1].boundary()[i].first *= 2;
//      candidate_path_boundaries[1].boundary()[i].second *= 2;
//      ADEBUG << "low kappa:" <<  -lat_acc_bound - kappa << " high kappa: " << lat_acc_bound - kappa;
      //ddl_bounds.emplace_back(-0.5, 0.5);
//    }
...
bool PathBoundsDecider::FindDestinationPullOverS(
  ...
  ADEBUG << "Destination s[" << destination_s
         << "] adc_end_s[" << adc_end_s << "]";
