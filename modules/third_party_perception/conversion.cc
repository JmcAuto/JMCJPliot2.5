...
using jmc_auto::drivers::DelphiESR;
using jmc_auto::drivers::Mobileye;
...
using jmc_auto::perception::Point;

std::map<std::int32_t, ::jmc_auto::hdmap::LaneBoundaryType_Type>
    lane_conversion_map = {{0, jmc_auto::hdmap::LaneBoundaryType::DOTTED_YELLOW},
                           {1, jmc_auto::hdmap::LaneBoundaryType::SOLID_YELLOW},
                           {2, jmc_auto::hdmap::LaneBoundaryType::UNKNOWN},
                           {3, jmc_auto::hdmap::LaneBoundaryType::CURB},
                           {4, jmc_auto::hdmap::LaneBoundaryType::SOLID_YELLOW},
                           {5, jmc_auto::hdmap::LaneBoundaryType::DOTTED_YELLOW},
                           {6, jmc_auto::hdmap::LaneBoundaryType::UNKNOWN}};
...
RadarObstacles DelphiToRadarObstacles(
  ...
  std::vector<jmc_auto::drivers::Esr_trackmotionpower_540::Motionpower>
      motionpowers(64);
  ...
  for (int index = 0; index < delphi_esr.esr_track01_500_size(); ++index) {
    ...
    if (data_500.can_tx_track_status() ==
        ::jmc_auto::drivers::Esr_track01_500::CAN_TX_TRACK_STATUS_NO_TARGET) {
      continue;
    }
