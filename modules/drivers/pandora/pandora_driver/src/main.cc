...
using jmc_auto::drivers::hesai::Pandora;
...
class PandoraHesaiClient {
 public:
  PandoraHesaiClient(ros::NodeHandle node, ros::NodeHandle nh) {
    ...
    std::string lidarTopic = "/jmc_auto/sensor/pandora/hesai40/PointCloud2";
    std::string cameraTopics[5];
    cameraTopics[0] = std::string("/jmc_auto/sensor/pandora/camera/front_color");
    cameraTopics[1] = std::string("/jmc_auto/sensor/pandora/camera/front_gray");
    cameraTopics[2] = std::string("/jmc_auto/sensor/pandora/camera/right_gray");
    cameraTopics[3] = std::string("/jmc_auto/sensor/pandora/camera/back_gray");
    cameraTopics[4] = std::string("/jmc_auto/sensor/pandora/camera/left_gray");
