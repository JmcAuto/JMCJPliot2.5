...
Compensator::Compensator(ros::NodeHandle node, ros::NodeHandle private_nh)
  ...
  private_nh.param("topic_compensated_pointcloud",
                   topic_compensated_pointcloud_, std::string("/jmc_auto/sensor/lslidar/compensator/PointCloud2"));
  private_nh.param("lslidar_point_cloud", topic_pointcloud_, std::string("/jmc_auto/sensor/lslidar/PointCloud2"));
