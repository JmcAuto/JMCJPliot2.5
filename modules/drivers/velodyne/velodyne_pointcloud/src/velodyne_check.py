...
def create_log_file():
    ...
    file_name = '/jmcauto/data/log/velodyne_hz.' + data_time + '.log'
    except_file_name = '/jmcauto/data/log/velodyne_hz.' + data_time + '.log.err'
    global LOG_FILE
...
def listener():
    ...
    topic = '/jmc_auto/sensor/velodyne64/compensator/PointCloud2'
