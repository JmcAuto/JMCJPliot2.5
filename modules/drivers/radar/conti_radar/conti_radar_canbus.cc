...
jmc_auto::common::Status ContiRadarCanbus::Init() {
  AdapterManager::Init(FLAGS_adapter_config_filename);
  AINFO << "The adapter manager is successfully initialized.";
  if (!::jmc_auto::common::util::GetProtoFromFile(FLAGS_sensor_conf_file,
                                                &conti_radar_conf_)) {
...
jmc_auto::common::ErrorCode ContiRadarCanbus::ConfigureRadar() {
...
jmc_auto::common::Status ContiRadarCanbus::Start() {
