...
#ifndef MODULES_DRIVERS_RADAR_TTE_CONTI_RADAR_PROTOCOL_DEBUG_ODDATAOUTPUT01_46B_H_
#define MODULES_DRIVERS_RADAR_TTE_CONTI_RADAR_PROTOCOL_DEBUG_ODDATAOUTPUT01_46B_H_
...
class Debugoddataoutput0146b : public ::jmc_auto::drivers::canbus::ProtocolData<
                    ::jmc_auto::drivers::TteContiRadar> {
 public:
  static const int32_t ID;
  Debugoddataoutput0146b();
 ...
 private:
  ...
  int od_data1output_y(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_data1output_x(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutput01_46b::Od_data1output_typeType od_data1output_type(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutput01_46b::Od_data1output_confidencelvlType od_data1output_confidencelvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_data0output_y(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_data0output_x(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutput01_46b::Od_data0output_typeType od_data0output_type(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutput01_46b::Od_data0output_confidencelvlType od_data0output_confidencelvl(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_CX75_PROTOCOL_DEBUG_ODDATAOUTPUT01_46B_H_
