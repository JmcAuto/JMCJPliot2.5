...
#ifndef MODULES_DRIVERS_RADAR_TTE_CONTI_RADAR_PROTOCOL_DEBUG_ODDATAOUTPUT89_46F_H_
#define MODULES_DRIVERS_RADAR_TTE_CONTI_RADAR_PROTOCOL_DEBUG_ODDATAOUTPUT89_46F_H_
...
class Debugoddataoutput8946f : public ::jmc_auto::drivers::canbus::ProtocolData<
                    ::jmc_auto::drivers::TteContiRadar> {
 public:
  static const int32_t ID;
  Debugoddataoutput8946f();
 ...
 private:
  ...
  Debug_oddataoutput89_46f::Od_data8output_confidencelvlType od_data8output_confidencelvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutput89_46f::Od_data8output_typeType od_data8output_type(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_data8output_x(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_data8output_y(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutput89_46f::Od_data9output_confidencelvlType od_data9output_confidencelvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutput89_46f::Od_data9output_typeType od_data9output_type(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_data9output_x(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_data9output_y(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_CX75_PROTOCOL_DEBUG_ODDATAOUTPUT89_46F_H_
