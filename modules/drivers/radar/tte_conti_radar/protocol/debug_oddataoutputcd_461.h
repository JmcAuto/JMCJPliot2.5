...
#ifndef MODULES_DRIVERS_RADAR_TTE_CONTI_RADAR_PROTOCOL_DEBUG_ODDATAOUTPUTCD_461_H_
#define MODULES_DRIVERS_RADAR_TTE_CONTI_RADAR_PROTOCOL_DEBUG_ODDATAOUTPUTCD_461_H_
...
class Debugoddataoutputcd461 : public ::jmc_auto::drivers::canbus::ProtocolData<
                    ::jmc_auto::drivers::TteContiRadar> {
 public:
  static const int32_t ID;
  Debugoddataoutputcd461();
 ...
 private:
  ...
  Debug_oddataoutputcd_461::Od_datacoutput_confidencelvlType od_datacoutput_confidencelvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutputcd_461::Od_datacoutput_typeType od_datacoutput_type(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_datacoutput_x(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_datacoutput_y(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutputcd_461::Od_datadoutput_confidencelvlType od_datadoutput_confidencelvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Debug_oddataoutputcd_461::Od_datadoutput_typeType od_datadoutput_type(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_datadoutput_x(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int od_datadoutput_y(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_CX75_PROTOCOL_DEBUG_ODDATAOUTPUTCD_461_H_
