...
#ifndef MODULES_DRIVERS_LIDAR_VELODYNE_COMMON_VELODYNE_GFLAGS_H_
#define MODULES_DRIVERS_LIDAR_VELODYNE_COMMON_VELODYNE_GFLAGS_H_

#include "gflags/gflags.h"

DECLARE_string(velodyne_module_name);
