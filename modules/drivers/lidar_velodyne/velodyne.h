...
/**
 * @namespace jmc_auto::velodyne
 * @brief jmc_auto::velodyne
 */
namespace jmc_auto {
namespace drivers {
 ...
 */
class Velodyne : public jmc_auto::common::JmcAutoApp {
 ...
 private:
  ...
  inline int64_t GetTime() {
    return jmc_auto::common::time::AsInt64<common::time::micros>(
