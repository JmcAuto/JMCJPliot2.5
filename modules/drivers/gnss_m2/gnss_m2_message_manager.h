 ...
 */
#ifndef MODULES_DRIVERS_GNSS_M2_GNSS_M2_MESSAGE_MANAGER_H_
#define MODULES_DRIVERS_GNSS_M2_GNSS_M2_MESSAGE_MANAGER_H_
...
class GnssM2MessageManager : public MessageManager< ::jmc_auto::drivers::gnss_m2::M2> {
 public:
  GnssM2MessageManager();
  virtual ~GnssM2MessageManager() {}
