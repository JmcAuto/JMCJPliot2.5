...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRSTATUS_737_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRSTATUS_737_H_
...
class Revrstatus737 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int diffid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int difftime(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double hdop_receiver(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int satelitenum_secondary(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int satelitenum_primary(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_REVRSTATUS_737_H_
