...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRALTITUDE_734_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRALTITUDE_734_H_
...
class Revraltitude734 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double altitude_receiver(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_REVRALTITUDE_734_H_
