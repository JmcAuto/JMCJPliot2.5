...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRGPSTIME_731_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRGPSTIME_731_H_
...
class Revrgpstime731 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double gpssecond_receiver(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int gpsweek_receiver(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_REVRGPSTIME_731_H_
