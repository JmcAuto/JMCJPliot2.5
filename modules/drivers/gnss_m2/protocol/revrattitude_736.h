...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRATTITUDE_736_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRATTITUDE_736_H_
...
class Revrattitude736 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double track_receiver(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double baseline(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double pitch_receiver(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double yaw_receiver(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_REVRATTITUDE_736_H_
