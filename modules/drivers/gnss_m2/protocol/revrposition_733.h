...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRPOSITION_733_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_REVRPOSITION_733_H_
...
class Revrposition733 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double longitude_receiver(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double latitude_receiver(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_REVRPOSITION_733_H_
