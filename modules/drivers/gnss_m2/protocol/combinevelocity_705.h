...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINEVELOCITY_705_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINEVELOCITY_705_H_
...
class Combinevelocity705 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double velocityhorizon(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double velocityup(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double velocitynorth(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double velocityeast(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_COMBINEVELOCITY_705_H_
