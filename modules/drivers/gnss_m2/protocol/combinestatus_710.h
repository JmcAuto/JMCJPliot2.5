...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINESTATUS_710_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINESTATUS_710_H_
...
class Combinestatus710 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int gearposition(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int gpsflag(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int dmiflag(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int navflag(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_COMBINESTATUS_710_H_
