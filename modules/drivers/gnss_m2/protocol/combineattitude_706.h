...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINEATTITUDE_706_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINEATTITUDE_706_H_
...
class Combineattitude706 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double roll(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double pitch(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double yaw(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_COMBINEATTITUDE_706_H_
