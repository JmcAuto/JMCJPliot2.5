...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_STDATTITUDE_709_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_STDATTITUDE_709_H_
...
class Stdattitude709 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double rollstd(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double pitchstd(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double yawstd(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_STDATTITUDE_709_H_
