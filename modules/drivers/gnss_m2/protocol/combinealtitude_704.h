...
#ifndef MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINEALTITUDE_704_H_
#define MODULES_CANBUS_VEHICLE_M2_PROTOCOL_COMBINEALTITUDE_704_H_
...
class Combinealtitude704 : public ::jmc_auto::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double altitudeundulation(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double altitude(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_M2_PROTOCOL_COMBINEALTITUDE_704_H_
