...
DECLARE_string(perception_roundview_obstacle_topic);
...
DECLARE_string(conti_radar_front_topic);
DECLARE_string(conti_radar_left_topic);
DECLARE_string(conti_radar_right_topic);
...
DECLARE_string(image_roundview_topic);
...
//DECLARE_string(localization_dy_topic);
DECLARE_string(tte_conti_radar_topic);
DECLARE_string(ros_imu_topic);

//for valid slot topic
DECLARE_string(valid_slot_topic);
