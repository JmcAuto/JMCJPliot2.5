  ...
  for (const auto &config : configs.config()) {
    switch (config.type()) {
      ...
      case AdapterConfig::PERCEPTION_OBSTACLES:
        ...
        break;
      case AdapterConfig::PERCEPTION_ROUNDVIEW_OBSTACLES:
        EnablePerceptionRoundviewObstacles(FLAGS_perception_roundview_obstacle_topic, config);
        break;
      ...
      case AdapterConfig::CONTI_RADAR:
        ...
        break;
      case AdapterConfig::CONTI_RADAR_FRONT:
        EnableContiRadar(FLAGS_conti_radar_front_topic, config);
        break;
      case AdapterConfig::CONTI_RADAR_LEFT:
        EnableContiRadar(FLAGS_conti_radar_left_topic, config);
        break;
      case AdapterConfig::CONTI_RADAR_RIGHT:
        EnableContiRadar(FLAGS_conti_radar_right_topic, config);
        break;
      ...
      case AdapterConfig::IMAGE_ROUNDVIEW:
        EnableImageRoundview(FLAGS_image_roundview_topic, config);
        break;
      ...
      case AdapterConfig::REMOTE_CONTROL:
        ...
        break;
      //case AdapterConfig::LOCALIZATION_DY:
      //  EnableLocalizationdy(FLAGS_localization_dy_topic, config);
      //  break;
      case AdapterConfig::TTE_CONTI_RADAR:
        EnableTteContiRadar(FLAGS_tte_conti_radar_topic, config);
        break;
      case AdapterConfig::ROS_IMU:
        EnableRosImu(FLAGS_ros_imu_topic, config);
        break;
      // for valid slot
      case AdapterConfig::VALID_SLOT:
        EnableValidSlot(FLAGS_valid_slot_topic, config);
        break;
      case AdapterConfig::INS:
        EnableIns(FLAGS_ins_topic, config);
        break;
