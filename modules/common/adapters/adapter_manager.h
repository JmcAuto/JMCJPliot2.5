...
class AdapterManager {
 ...
 private:
  ...
  REGISTER_ADAPTER(PerceptionRoundviewObstacles);
  ...
  REGISTER_ADAPTER(ImageRoundview);
  ...
  REGISTER_ADAPTER(TteContiRadar);

  REGISTER_ADAPTER(RosImu);

  //for valid slot
  REGISTER_ADAPTER(ValidSlot);
