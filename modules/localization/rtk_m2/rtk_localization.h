 ...
 * @brief The class of RTKM2Localization
 */

#ifndef MODULES_LOCALIZATION_RTK_M2_RTK_LOCALIZATION_H_
#define MODULES_LOCALIZATION_RTK_M2_RTK_LOCALIZATION_H_
...
/**
 * @class RTKM2Localization
 *
 * @brief generate localization info based on RTK
 */
class RTKM2Localization : public LocalizationBase {
 public:
  RTKM2Localization();
  virtual ~RTKM2Localization();
 ...
 private:
  ...
  projPJ utm_target_;
  jmc_auto::drivers::gnss::Ins ins_;
  // jmc_auto::drivers::gnss::Imu imu_;
  // FRIEND_TEST(RTKM2LocalizationTest, InterpolateIMU);
  // FRIEND_TEST(RTKM2LocalizationTest, ComposeLocalizationMsg);
