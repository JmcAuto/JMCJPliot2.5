...
#include "modules/tools/map_cidi2jinglong/jinglong_proto/map_lane.pb.h"
...
class NodeCreator {
 ...
 private:
  ...
  static void InitNodeInfo(const Lane& lane, const std::string& road_id,
                           Node* const node,
                           const RoutingConfig* routingconfig);
  static void InitNodeCost(const Lane& lane, Node* const node,
                           const RoutingConfig* routingconfig);
};
