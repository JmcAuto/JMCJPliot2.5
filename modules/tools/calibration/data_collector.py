...
class DataCollector(object):
    ...
    def __init__(self):
        ...
        self.control_pub = rospy.Publisher(
            '/jmc_auto/control', control_cmd_pb2.ControlCommand, queue_size=1)
        rospy.sleep(0.3)
...
def main():
    ...
    plotter = Plotter()
    localizationsub = rospy.Subscriber('/jmc_auto/localization/pose',
                                       localization_pb2.LocalizationEstimate,
                                       data_collector.callback_localization)
    canbussub = rospy.Subscriber('/jmc_auto/canbus/chassis', chassis_pb2.Chassis,
