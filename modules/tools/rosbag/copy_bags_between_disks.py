...
K_CHASSIS_TOPIC = '/jmc_auto/canbus/chassis'
K_DRIVE_EVENT_TOPIC = '/jmc_auto/drive_event'
...
def GetDisks():
    ...
    disks.append('/jmc_auto')
    # The disks are sorted like
    #   /media/jmc_auto/internal_nvme
    #   /media/jmc_auto/jmc_auto8
    #   /jmc_auto
...
def main():
    ...
    other_data_dirs = {'/jmcauto/data/gpsbin': 'data/gpsbin'}
