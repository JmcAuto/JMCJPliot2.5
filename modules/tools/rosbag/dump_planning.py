...
def dump_bag(in_bag, out_dir):
    ...
    global g_args
    topic_name_map = {
        "/jmc_auto/localization/pose" : ["localization", None],
        "/jmc_auto/canbus/chassis" : ["chassis", None],
        "/jmc_auto/routing_response" : ["routing", None],
        "/jmc_auto/routing_resquest" : ["routing_request", None],
        "/jmc_auto/perception/obstacles" : ["perception", None],
        "/jmc_auto/prediction" : ["prediction", None],
        "/jmc_auto/planning" : ["planning", None],
        "/jmc_auto/control" : ["control", None]
    }
    first_time = None
    record_num = 0
