...
class OdomPublisher(object):
    def __init__(self):
        ...
        self.gps_odom_pub = rospy.Publisher('/jmc_auto/sensor/gnss/odometry', gps_pb2.Gps, queue_size=1) 
        self.sequence_num = 0
...
def main():
    ...
    odom = OdomPublisher()
    rospy.Subscriber('/jmc_auto/localization/pose', localization_pb2.LocalizationEstimate, odom.localization_callback)
    rate = rospy.Rate(100)
