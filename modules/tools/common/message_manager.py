...
topic_pb_list = [
    MessageType("planning", "/jmc_auto/planning", planning_pb2.ADCTrajectory),
    MessageType("control", "/jmc_auto/control", control_cmd_pb2.ControlCommand),
    MessageType("chassis", "/jmc_auto/canbus/chassis", chassis_pb2.Chassis),
    MessageType("prediction", "/jmc_auto/prediction",
                prediction_obstacle_pb2.PredictionObstacles),
    MessageType("perception", "/jmc_auto/perception",
                perception_obstacle_pb2.PerceptionObstacles),
    MessageType("routing_response", "/jmc_auto/routing_response",
                routing_pb2.RoutingResponse),
    MessageType("routing_request", "/jmc_auto/routing_request",
                routing_pb2.RoutingRequest),
    MessageType("localization", "/jmc_auto/localization/pose",
                localization_pb2.LocalizationEstimate),
    MessageType("traffic_light", "/jmc_auto/perception/traffic_light",
                traffic_light_detection_pb2.TrafficLightDetection),
    MessageType("drive_event", "/jmc_auto/drive_event",
                drive_event_pb2.DriveEvent),
    MessageType("relative_map", "/jmc_auto/relative_map", navigation_pb2.MapMsg),
    MessageType("relative_map", "/jmc_auto/navigation",
