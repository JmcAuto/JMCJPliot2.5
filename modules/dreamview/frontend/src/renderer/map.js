...
export default class Map {
    ...
    addLaneMesh(laneType, points) {
        //console.log("your addlaneMesh points is: ");
        //console.log(points);
        switch (laneType) {
            case "DOTTED_YELLOW":
    ...
    addLane(lane, coordinates, scene) {
        const drewObjects = [];
        //console.log("your addlane coordinates is: ");
        ...
        centralLine.forEach(segment => {
            ...
            //console.log("your addlane points is: ");
            //console.log(points);
        });
...
//point为地图lane的数据点
//将所有的点都转换到由车辆为起点，元素点为终点的向量
                const points = coordinates.applyOffsetToArray(segment.lineSegment.point);
                //console.log("your segment.lineSegment.point is: ");
                //console.log(segment.lineSegment.point);
                //console.log("your rightlanetype is: ");
                //console.log(points);
                //console.log("lane.rightBoundary.curve.segment is: ");
                //console.log(lane.rightBoundary.curve.segment);
        ...
        //console.log("your drewObjects is: ");
    ...
    // I do not want to do premature(预先) optimization either. Should the
    // performance become an issue, all the diff（差分、差异） should be done at the server
    // side. This also means that the server should maintain a state of
    // (possibly) visible elements, presummably（大概、推测） in the global store.
            ...
            for (let i = 0; i < newData[kind].length; ++i) {
                switch (kind) {
                    case "lane":
                        ...
                        //assign(target, source),将源对象的属性和值赋给目标对象，合并对象，返回新的对象
