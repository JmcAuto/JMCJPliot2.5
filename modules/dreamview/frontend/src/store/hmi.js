...
export default class HMI {
    ...
    @action update(world) {
        ...
        this.enablePause = world.autoDrivingCar.disengageType === "DISENGAGE_NONE";
    }
    ...
    updateParkingPointStatus(ParkingPointCheck_status) {
        this.ParkingPointCheck_status = ParkingPointCheck_status;
    }
