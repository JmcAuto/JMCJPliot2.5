...
import summonIcon from "assets/images/routing/summon.png";
        ...
        return (
            <div className="route-editing-bar">
                <div className="editing-panel">
                    ...
                    <RouteEditingButton label="Send Summon Request"
                                      icon={sendRouteIcon}
                                      onClick={() => {
                                        routeEditingManager.sendSummonRequest();
                                    }}/>
                    <RouteEditingButton label="Send Parking Request"
                                        icon={sendRouteIcon}
                                        onClick={() => {
                                        routeEditingManager.sendParkingRequest();
                    }}/>
                    <EditingTip />
                </div>
            </div>
