...
//                this.speechSynthesis('Setup');
        ...
        this.reset = {
            "Reset All": () => {
 //               console.log(meters.gearLocation);
...
//                this.speechSynthesis('Reset All');
        ...
        this.auto = {
            "Start Auto": () => {
  //               console.log(meters.gearLocation);
  //              if (world.autoDrivingCar.disengageTypegear !== "GEAR_REVERS"){
  //                  alert("Please put gear to R!");
  //              } else{
...
//            this.speechSynthesis('Start Auto');
        ...
        this.pause = {
            "Pause": () => {
                WS.changeDrivingAction("Pause");
            },
        };

        this.continue_ = {
            "Continue": () => {
                WS.changeDrivingAction("keepOn");
            },
        };
    }
        ...
        return (
            <div className="card">
                ...
                <div className="card-content-column">
                    ...
                    <CommandGroup disabled={!hmi.enablePause || tasksPanelLocked}
                    commands={this.pause} />
                    <CommandGroup disabled={!hmi.enablePause || tasksPanelLocked}
                    commands={this.continue_} />
                    {hmi.showRTKCommands &&
