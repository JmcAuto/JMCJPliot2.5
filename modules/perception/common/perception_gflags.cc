...
DEFINE_string(work_root, "/jmcauto/modules/perception/",
...
/* dag streaming config for JmcAuto 2.0 */
...
// Ex: /jmcauto/modules/perception/data/yolo_camera_detector_test/test.jpg
...
DEFINE_bool(is_map_slotcheck,true,"True is using map slot check");
