...
CLOUD_TOPIC="/jmc_auto/sensor/velodyne$LIDAR_TYPE/compensator/PointCloud2"
...
function poses_interpolation() {
  ...
  $JMC_AUTO_BIN_PREFIX/modules/localization/msf/local_tool/map_creation/poses_interpolator \
...
function create_lossless_map() {
  $JMC_AUTO_BIN_PREFIX/modules/localization/msf/local_tool/map_creation/lossless_map_creator \
...
function create_lossy_map() {
  $JMC_AUTO_BIN_PREFIX/modules/localization/msf/local_tool/map_creation/lossless_map_to_lossy_map \
