...
routing_topic="topic == '/jmc_auto/routing_response'"

perception_topic="topic == '/jmc_auto/perception/obstacles' \
   or topic == '/jmc_auto/perception/traffic_light'"

perfect_control_topic="$perception_topic  \
   or $routing_topic \
   or topic == '/jmc_auto/perception/obstacles' \
   or topic == '/jmc_auto/prediction' \
   or topic == '/jmc_auto/control' \
   or topic == '/jmc_auto/perception/traffic_light'"

planning_deps="$perfect_control_topic \
    or topic == '/jmc_auto/canbus/chassis' \
    or topic == '/jmc_auto/localization/pose' \
    or topic == '/jmc_auto/navigation' \
    or topic == '/jmc_auto/guardian' \
    or topic == '/jmc_auto/monitor/system_status' \
    or topic == '/jmc_auto/relative_map'"

planning_topic="topic == '/jmc_auto/planning'"
prediction_topic="topic == '/jmc_auto/prediction'"

planning_all="topic == '/jmc_auto/planning' \
    or topic == '/jmc_auto/drive_event' \
    or $planning_deps"

camera_only="topic != '/jmc_auto/perception/obstacles' \
    and topic != '/jmc_auto/prediction' \
    and topic != '/jmc_auto/planning'"
