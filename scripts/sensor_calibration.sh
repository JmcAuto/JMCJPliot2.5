...
function calibrate_camera_camera() {
  LOG="${JMC_AUTO_ROOT_DIR}/data/log/camera_camera_calibrator.out"
  ...
  if [ "${NUM_PROCESSES}" -eq 0 ]; then
    ...
    eval "${JMC_AUTO_ROOT_DIR}/modules/calibration/${MODULE}/${MODULE} \
...
function calibrate_lidar_camera() {
  LOG="${JMC_AUTO_ROOT_DIR}/data/log/camera_lidar_calibrator.out"
...
function calibrate_radar_camera() {
  LOG="${JMC_AUTO_ROOT_DIR}/data/log/camera_radar_calibrator.out"
...
function visualize_radar_lidar() {
  LOG="${JMC_AUTO_ROOT_DIR}/data/log/radar_lidar_visualizer.out"
